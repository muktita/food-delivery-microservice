...
class GraphPath {
    ...
    checkDirectPathFromPreviousSubgraphTo(typeName, triggerToEdge, prevSubgraphStartingVertex) {
...
function advancePathWithNonCollectingAndTypePreservingTransitions(path, context, conditionResolver, excludedDestinations, excludedConditions, convertTransitionWithCondition, triggerToEdge) {
    var _a, _b, _c;
